...
public class Level1ProgressFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootview = (ViewGroup) inflater.inflate(R.layout.layout_for_level1_progress, container, false);
        ...
        mScore = sharedPreferences.getInt("Level 1Score", 0);
