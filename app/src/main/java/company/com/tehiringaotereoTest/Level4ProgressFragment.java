...
public class Level4ProgressFragment extends Fragment {
    private int mScore;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootview = (ViewGroup) inflater.inflate(R.layout.layout_for_level3_progress, container, false);
        ...
        mScore = sharedPreferences.getInt("Level 4Score", 0);
