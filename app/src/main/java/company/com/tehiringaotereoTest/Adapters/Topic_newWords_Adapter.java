...
public class Topic_newWords_Adapter extends BaseAdapter {
    ...
    public Topic_newWords_Adapter(Context context, ArrayList<String> EnglishWords, ArrayList<String> MaoriWords, ArrayList<Integer> VoiceId, MediaPlayer mplayer) {
        this.c = context;
