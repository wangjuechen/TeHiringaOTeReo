...
public class VoiceOpenPrayerPlayer extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.voice_openingprayerplayer);
        ...
        mPlayer = MediaPlayer.create(VoiceOpenPrayerPlayer.this, R.raw.karakiaopen);
